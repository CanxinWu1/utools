# role-workspaces Specification

## Purpose
Role workspaces define how SwiftBox turns role navigation into focused acceleration surfaces while preserving the full tool catalog, global search, favorites, recents, and sensitive-input boundaries.
